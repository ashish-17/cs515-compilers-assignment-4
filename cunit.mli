...
(* It is processed by the assembler to produce an object file. *)
...
| GLabelOffset of Rux86.lbl * int32 (** A label with offset *)
| GLabels of Rux86.lbl list (** labels *)
...
type global_data = {
  ...
  label  : Rux86.lbl;       (** The label of this data *)
